...
The premise for the chatbots may have been flawed, they were being trained on data from human negotiators. The chatbots had to learn what was an effective negotiating strategy with a human, after this it had to apply the same negotiating strategy with another chatbot. However inside the human negotiation strategy were hidden culturial constraints, for instance as a human I may *feel* it is *not right* to ask for something without giving away something in return. But this culturial characteristic may not be necessary between chatbots and they learned to exhibit this through learning to decieve. Perhaps these bots just offended us inadvertently?
